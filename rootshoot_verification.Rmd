...
gg <- plot_map3(nc_rootmassfraction, varnam = "div", latmin = -55, latmax = 80, nbin = 12, plot_title = "LPJ-GUESS")
gg

tibble(rootmassfraction = c(nc_rootmassfraction$vars$div)) %>%
  ggplot(aes(x = rootmassfraction)) +
  geom_histogram() +
  labs( title = "LPJ-GUESS")
```
...
<!-- gg <- plot_map3(nc_rootmassfraction, varnam = "div", latmin = -55, latmax = 80, nbin = 12, plot_title = "ORCHIDEE-CNP") -->
<!-- gg -->

<!-- tibble(rootmassfraction = c(nc_rootmassfraction$vars$div)) %>% -->
<!--   ggplot(aes(x = rootmassfraction)) + -->
<!--   geom_histogram() + -->
<!--   labs( title = "ORCHIDEE-CNP") -->
<!-- ``` -->

<!-- ## CABLE-POP -->

<!-- ```{r} -->
<!-- nc_root <- read_nc_onefile("~/data/trendy/v8/CABLE-POP_S2_cRoot.nc") -->
...
<!-- gg <- plot_map3(nc_rootmassfraction, varnam = "div", latmin = -55, latmax = 80, nbin = 12, plot_title = "CABLE-POP") -->
<!-- gg -->

<!-- tibble(rootmassfraction = c(nc_rootmassfraction$vars$div)) %>% -->
<!--   ggplot(aes(x = rootmassfraction)) + -->
<!--   geom_histogram() + -->
<!--   labs( title = "CABLE-POP") -->
<!-- ``` -->