...
% This file was used to convert CMIP5 nc files downloaded from CMIP5
% database into nc files in \dgvm_analyses\CMIP5\Processed_data\processed
% Check the first several lines of codes for model name and model variable.
