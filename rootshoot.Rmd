...
df <- filnams %>% 
  ...
  mutate(cmd = paste("./calc_mass_fraction.sh", filn_cWood, filn_cVeg, varn_cWood, varn_cVeg, dir))
```
...
df <- filnams %>% 
  ...
  mutate_at(vars(starts_with("filn_")), ~str_replace(., ".nc", "")) %>% 
  mutate(dir = paste0("/cluster/home/bestocke/data/trendy/v5/", modl, "/S1/")) %>% 
  mutate(cmd = paste("./calc_mass_fraction.sh", filn_cLeaf, filn_cVeg, varn_cLeaf, varn_cVeg, dir))
```
...
df <- filnams %>% 
  ...
  mutate_at(vars(starts_with("filn_")), ~str_replace(., ".nc", "")) %>% 
  mutate(dir = paste0("/cluster/home/bestocke/data/trendy/v5/", modl, "/S1/")) %>% 
  mutate(cmd = paste("./calc_mass_fraction.sh", filn_cRoot, filn_cVeg, varn_cRoot, varn_cVeg, dir))
```
...
df <- filnams %>% 
  ...
  mutate_at(vars(starts_with("filn_")), ~str_replace(., ".nc", "")) %>% 
  mutate(dir = paste0("/cluster/home/bestocke/data/trendy/v5/", modl, "/S1/")) %>% 
  mutate(cmd = paste("./calc_rootshoot_ratio.sh", filn_cRoot, filn_cVeg, varn_cRoot, varn_cVeg, dir))
```
