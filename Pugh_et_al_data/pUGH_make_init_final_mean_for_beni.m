...
cd E:\Cesar_project_csoil\Pugh_data
...
for Modelnum=1:length(Model_list)
    ...
    File = dir(strcat('seib_cruncep_npp_month_1901_2014.nc4'));
    if ~isempty(File)
        ...
        Csoil_before=nanmean(Csoil(:,:,1:120),3).*31536000; % Average across the 24 25 26 27 28 29 30 31 32th years
        Csoil_After=nanmean(Csoil(:,:,1248:1368),3).*31536000;% Average across the 74 75 76 77 78 79 80 81 82th years
